...
// 모각
    ...
    //내가 쓴 이어달린 톡
    GetPage(
        name: ViewRoute.FollowUpTalkPage, page: () => const FollowUpTalks()),

    //내 캐치업
    GetPage(name: ViewRoute.MyCatchUpPage, page: () => const MyCatchUp()),

    //좋아요 한 캐치업
    GetPage(name: ViewRoute.LikedCatchPage, page: () => const LikedCatch()),
    ...
    //참여중인 그룹
    GetPage(
        name: ViewRoute.MyJoinedGroupsPage, page: () => const JoindeGroups()),
    //내정보 수정하기
    GetPage(name: ViewRoute.EditProfilePage, page: () => const EditProfile()),
    //비밀번호 변경
    GetPage(
        name: ViewRoute.PasswordUpdatePage, page: () => const PasswordUpdate()),
  ];
}
